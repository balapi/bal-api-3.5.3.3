...
#define BCMOLT_DEVICE_CFG_DATA_PRESENCE_MASK_ALL 0x00000000F81F3EFFULL
...
#define BCMOLT_DEVICE_CONNECT_DATA_PRESENCE_MASK_ALL 0x00000000000000EFULL
...
{
    bcmolt_presence_mask presence_mask;
    bcmolt_port_command command; /**< Update an ERPS ring port. */
...
#define BCMOLT_ERPS_INTERFACE_PORT_UPDATE_DATA_PRESENCE_MASK_ALL 0x0000000000000005ULL
...
} bcmolt_erps_interface_erps_port_update_data;

/* Constants associated with bcmolt_erps_interface_erps_port_update_data. */
#define BCMOLT_ERPS_INTERFACE_ERPS_PORT_UPDATE_DATA_PRESENCE_MASK_ALL 0x0000000000000007ULL

/** Transport message definition for "erps_port_update" group of "erps_interface" object. */
typedef struct
{
    bcmolt_auto hdr; /**< Transport header. */
    bcmolt_erps_interface_key key; /**< Object key. */
    bcmolt_erps_interface_erps_port_update_data data; /**< All properties that must be set by the user. */
} bcmolt_erps_interface_erps_port_update;

/** ERPS Interface: Indication Configuration */
typedef struct
{
    bcmolt_presence_mask presence_mask;
    bcmos_bool erps_port_update; /**< If true, indications of type "erps_port_update" will be generated. */
...
#define BCMOLT_ERPS_INTERFACE_AUTO_CFG_DATA_PRESENCE_MASK_ALL 0x0000000000000003ULL
...
#define BCMOLT_FLOW_CFG_DATA_PRESENCE_MASK_ALL 0x0000000000003FFFULL
...
#define BCMOLT_INTERNAL_NNI_CFG_DATA_PRESENCE_MASK_ALL 0x0000000000000FBEULL
...
#define BCMOLT_INTERNAL_NNI_AUTO_CFG_DATA_PRESENCE_MASK_ALL 0x0000000000000003ULL
...
typedef struct
{
    ...
    uint32_t mtu; /**< max frame size in bytes */
...
#define BCMOLT_NNI_INTERFACE_CFG_DATA_PRESENCE_MASK_ALL 0x0000000000000FFBULL
...
#define BCMOLT_ONU_AUTO_CFG_DATA_PRESENCE_MASK_ALL 0x0003FFFFFFFFFFFFULL
...
/** pon interface: Get BW eligibility class level statistics */
typedef struct
{
    bcmolt_presence_mask presence_mask;
    bcmolt_additional_bw_eligibility bw_eligibility; /**< The BW eligibility class to run statistics for */
    uint32_t priority; /**< The priority to run statistics for (relevant only for best-effort BW eligibility class) */
    uint32_t num_of_cycles; /**< The number of cycles to run statistics collection */
} bcmolt_pon_interface_get_bw_eligibility_stats_data;

/* Constants associated with bcmolt_pon_interface_get_bw_eligibility_stats_data. */
#define BCMOLT_PON_INTERFACE_GET_BW_ELIGIBILITY_STATS_DATA_PRESENCE_MASK_ALL 0x0000000000000007ULL

/** Transport message definition for "get_bw_eligibility_stats" group of "pon_interface" object. */
typedef struct
{
    bcmolt_oper hdr; /**< Transport header. */
    bcmolt_pon_interface_key key; /**< Object key. */
    bcmolt_pon_interface_get_bw_eligibility_stats_data data; /**< All properties that must be set by the user. */
} bcmolt_pon_interface_get_bw_eligibility_stats;

/** pon interface: Get BW eligibility class level statistics completed */
typedef struct
{
    bcmolt_presence_mask presence_mask;
    bcmolt_result status; /**< status. */
    bcmolt_additional_bw_eligibility bw_eligibility; /**< BW eligibility class. */
    uint32_t priority; /**< Priority. */
    uint32_t average_nsr_used; /**< Average NSR used words. */
    uint32_t average_nsr_allocated; /**< Average NSR allocated words. */
    uint32_t average_sr_report; /**< Average SR report. */
} bcmolt_pon_interface_get_bw_eligibility_stats_completed_data;

/* Constants associated with bcmolt_pon_interface_get_bw_eligibility_stats_completed_data. */
#define BCMOLT_PON_INTERFACE_GET_BW_ELIGIBILITY_STATS_COMPLETED_DATA_PRESENCE_MASK_ALL 0x000000000000003FULL

/** Transport message definition for "get_bw_eligibility_stats_completed" group of "pon_interface"
  * object. */
typedef struct
{
    bcmolt_auto hdr; /**< Transport header. */
    bcmolt_pon_interface_key key; /**< Object key. */
    bcmolt_pon_interface_get_bw_eligibility_stats_completed_data data; /**< All properties that must be set by the user. */
} bcmolt_pon_interface_get_bw_eligibility_stats_completed;
...
typedef struct
{
    ...
    bcmos_bool get_bw_eligibility_stats_completed; /**< If true, indications of type "get_bw_eligibility_stats_completed" will be generated. */
...
#define BCMOLT_PON_INTERFACE_AUTO_CFG_DATA_PRESENCE_MASK_ALL 0x00000000000FFFFFULL
