...
typedef enum
{
    ...
    BCMOLT_PON_TYPE_EPON = 7, /**< EPON */
    BCMOLT_PON_TYPE_AE_1G = 8, /**< AE 1G */
    BCMOLT_PON_TYPE_AE_10G = 9, /**< AE 10G */
    BCMOLT_PON_TYPE_AE_25G = 10, /**< AE 25G */
...
typedef enum
{
    ...
    BCMOLT_PORT_COMMAND_ADD_WEST_PORT = 1, /**< add members */
    BCMOLT_PORT_COMMAND_REMOVE_WEST_PORT = 2, /**< remove members */
...
typedef enum
{
    ...
    BCMOLT_RING_PORT_WEST = 1, /**< ERPS Ring West Ring Port */
...
typedef enum
{
    ...
    BCMOLT_API_GROUP_ID_ERPS_INTERFACE_PORT_UPDATE = 34, /**< ERPS Interface - erps port update. */
    BCMOLT_API_GROUP_ID_ERPS_INTERFACE_ERPS_PORT_UPDATE = 35, /**< ERPS Interface - erps port update. */
    BCMOLT_API_GROUP_ID_ERPS_INTERFACE_AUTO_CFG = 36, /**< ERPS Interface - Indication Configuration. */
    BCMOLT_API_GROUP_ID_ETH_OAM_KEY = 37, /**< Ethernet OAM - key. */
    BCMOLT_API_GROUP_ID_ETH_OAM_CFG = 38, /**< Ethernet OAM - cfg. */
    BCMOLT_API_GROUP_ID_ETH_OAM_CCM_EVENT = 39, /**< Ethernet OAM - CFM CCM Event. */
    BCMOLT_API_GROUP_ID_ETH_OAM_SET_MEP_STATE = 40, /**< Ethernet OAM - Set MEP Control State. */
    BCMOLT_API_GROUP_ID_ETH_OAM_STATE_CHANGE = 41, /**< Ethernet OAM - State Change. */
    BCMOLT_API_GROUP_ID_ETH_OAM_AUTO_CFG = 42, /**< Ethernet OAM - Indication Configuration. */
    BCMOLT_API_GROUP_ID_FLOW_CFG = 43, /**< BAL Flow - cfg. */
    BCMOLT_API_GROUP_ID_FLOW_KEY = 44, /**< BAL Flow - key. */
    BCMOLT_API_GROUP_ID_FLOW_SEND_ETH_PACKET = 45, /**< BAL Flow - send_eth_packet. */
    BCMOLT_API_GROUP_ID_GPIO_KEY = 46, /**< GPIO - key. */
    BCMOLT_API_GROUP_ID_GPIO_CFG = 47, /**< GPIO - cfg. */
    BCMOLT_API_GROUP_ID_GROUP_CFG = 48, /**< BAL Group - cfg. */
    BCMOLT_API_GROUP_ID_GROUP_KEY = 49, /**< BAL Group - key. */
    BCMOLT_API_GROUP_ID_GROUP_MEMBERS_UPDATE = 50, /**< BAL Group - members_update. */
    BCMOLT_API_GROUP_ID_GROUP_COMPLETE_MEMBERS_UPDATE = 51, /**< BAL Group - complete_members_update. */
    BCMOLT_API_GROUP_ID_GROUP_AUTO_CFG = 52, /**< BAL Group - Indication Configuration. */
    BCMOLT_API_GROUP_ID_INBAND_MGMT_CHANNEL_CFG = 53, /**< BAL Inband Management Channel - cfg. */
    BCMOLT_API_GROUP_ID_INBAND_MGMT_CHANNEL_KEY = 54, /**< BAL Inband Management Channel - key. */
    BCMOLT_API_GROUP_ID_INTERNAL_NNI_KEY = 55, /**< Internal NNI - key. */
    BCMOLT_API_GROUP_ID_INTERNAL_NNI_CFG = 56, /**< Internal NNI - cfg. */
    BCMOLT_API_GROUP_ID_INTERNAL_NNI_STATUS_CHANGED = 57, /**< Internal NNI - Status changed. */
    BCMOLT_API_GROUP_ID_INTERNAL_NNI_PACKET_CAPTURED = 58, /**< Internal NNI - Packet Captured. */
    BCMOLT_API_GROUP_ID_INTERNAL_NNI_SEND_ETH_PACKET = 59, /**< Internal NNI - send_eth_packet. */
    BCMOLT_API_GROUP_ID_INTERNAL_NNI_AUTO_CFG = 60, /**< Internal NNI - Indication Configuration. */
    BCMOLT_API_GROUP_ID_ITUPON_ALLOC_KEY = 61, /**< ITU PON Alloc - key. */
    BCMOLT_API_GROUP_ID_ITUPON_ALLOC_CFG = 62, /**< ITU PON Alloc - cfg. */
    BCMOLT_API_GROUP_ID_ITUPON_ALLOC_CONFIGURATION_COMPLETED = 63, /**< ITU PON Alloc - Configuration Completed. */
    BCMOLT_API_GROUP_ID_ITUPON_ALLOC_GET_STATS = 64, /**< ITU PON Alloc - Get alloc level statistics. */
    BCMOLT_API_GROUP_ID_ITUPON_ALLOC_GET_ALLOC_STATS_COMPLETED = 65, /**< ITU PON Alloc - Get alloc level statistics completed. */
    BCMOLT_API_GROUP_ID_ITUPON_ALLOC_SET_STATE = 66, /**< ITU PON Alloc - Set state. */
    BCMOLT_API_GROUP_ID_ITUPON_ALLOC_AUTO_CFG = 67, /**< ITU PON Alloc - Indication Configuration. */
    BCMOLT_API_GROUP_ID_ITUPON_GEM_KEY = 68, /**< ITU PON GEM Port - key. */
    BCMOLT_API_GROUP_ID_ITUPON_GEM_CFG = 69, /**< ITU PON GEM Port - cfg. */
    BCMOLT_API_GROUP_ID_ITUPON_GEM_CONFIGURATION_COMPLETED = 70, /**< ITU PON GEM Port - Configuration Completed. */
    BCMOLT_API_GROUP_ID_ITUPON_GEM_SET_STATE = 71, /**< ITU PON GEM Port - Set state. */
    BCMOLT_API_GROUP_ID_ITUPON_GEM_AUTO_CFG = 72, /**< ITU PON GEM Port - Indication Configuration. */
    BCMOLT_API_GROUP_ID_LAG_INTERFACE_KEY = 73, /**< LAG interface - key. */
    BCMOLT_API_GROUP_ID_LAG_INTERFACE_CFG = 74, /**< LAG interface - cfg. */
    BCMOLT_API_GROUP_ID_LAG_INTERFACE_MEMBERS_UPDATE = 75, /**< LAG interface - members_update. */
    BCMOLT_API_GROUP_ID_LAG_INTERFACE_COMPLETE_MEMBERS_UPDATE = 76, /**< LAG interface - complete_members_update. */
    BCMOLT_API_GROUP_ID_LAG_INTERFACE_STATE_UPDATE = 77, /**< LAG interface - state_update. */
    BCMOLT_API_GROUP_ID_LAG_INTERFACE_STATE_UPDATED = 78, /**< LAG interface - interface state updated. */
    BCMOLT_API_GROUP_ID_LAG_INTERFACE_LAG_HEALTH_CHANGE = 79, /**< LAG interface - LAG health change. */
    BCMOLT_API_GROUP_ID_LAG_INTERFACE_AUTO_CFG = 80, /**< LAG interface - Indication Configuration. */
    BCMOLT_API_GROUP_ID_LOG_KEY = 81, /**< Log - key. */
    BCMOLT_API_GROUP_ID_LOG_CFG = 82, /**< Log - cfg. */
    BCMOLT_API_GROUP_ID_LOG_FILE_KEY = 83, /**< Log File - key. */
    BCMOLT_API_GROUP_ID_LOG_FILE_CFG = 84, /**< Log File - cfg. */
    BCMOLT_API_GROUP_ID_LOG_FILE_CLEAR = 85, /**< Log File - Clear. */
    BCMOLT_API_GROUP_ID_LOG_FILE_RESET_BUFFER_PTR = 86, /**< Log File - Reset Buffer Pointer. */
    BCMOLT_API_GROUP_ID_NGPON2_CHANNEL_KEY = 87, /**< Channel - key. */
    BCMOLT_API_GROUP_ID_NGPON2_CHANNEL_CFG = 88, /**< Channel - cfg. */
    BCMOLT_API_GROUP_ID_NNI_INTERFACE_KEY = 89, /**< nni_interface - key. */
    BCMOLT_API_GROUP_ID_NNI_INTERFACE_STATE_CHANGE = 90, /**< nni_interface - State Change. */
    BCMOLT_API_GROUP_ID_NNI_INTERFACE_CFG = 91, /**< nni_interface - cfg. */
    BCMOLT_API_GROUP_ID_NNI_INTERFACE_SET_NNI_STATE = 92, /**< nni_interface - set_nni_state. */
    BCMOLT_API_GROUP_ID_NNI_INTERFACE_LINK_STATE_CHANGE = 93, /**< nni_interface - link_state_change. */
    BCMOLT_API_GROUP_ID_NNI_INTERFACE_AUTO_CFG = 94, /**< nni_interface - Indication Configuration. */
    BCMOLT_API_GROUP_ID_OLT_KEY = 95, /**< olt - key. */
    BCMOLT_API_GROUP_ID_OLT_CFG = 96, /**< olt - cfg. */
    BCMOLT_API_GROUP_ID_OLT_CONNECT = 97, /**< olt - connect. */
    BCMOLT_API_GROUP_ID_OLT_CONNECTED = 98, /**< olt - connected. */
    BCMOLT_API_GROUP_ID_OLT_DISCONNECT = 99, /**< olt - disconnect. */
    BCMOLT_API_GROUP_ID_OLT_BAL_RESET = 100, /**< olt - Reset BAL and Switch. */
    BCMOLT_API_GROUP_ID_OLT_DISCONNECTED = 101, /**< olt - disconnected. */
    BCMOLT_API_GROUP_ID_OLT_BAL_FAILURE = 102, /**< olt - BAL and/or Switch Failed. */
    BCMOLT_API_GROUP_ID_OLT_BAL_READY = 103, /**< olt - BAL and Switch Ready. */
    BCMOLT_API_GROUP_ID_OLT_SW_ERROR = 104, /**< olt - OLT Software error. */
    BCMOLT_API_GROUP_ID_OLT_RESET = 105, /**< olt - OLT Reset. */
    BCMOLT_API_GROUP_ID_OLT_AUTO_CFG = 106, /**< olt - Indication Configuration. */
    BCMOLT_API_GROUP_ID_ONU_KEY = 107, /**< ONU - key. */
    BCMOLT_API_GROUP_ID_ONU_CFG = 108, /**< ONU - cfg. */
    BCMOLT_API_GROUP_ID_ONU_SET_ONU_STATE = 109, /**< ONU - Set ONU State. */
    BCMOLT_API_GROUP_ID_ONU_RSSI_MEASUREMENT = 110, /**< ONU - RSSI Measurement. */
    BCMOLT_API_GROUP_ID_ONU_REQUEST_REGISTRATION = 111, /**< ONU - Request registration. */
    BCMOLT_API_GROUP_ID_ONU_CHANGE_POWER_LEVELLING = 112, /**< ONU - Change power levelling. */
    BCMOLT_API_GROUP_ID_ONU_GET_POWER_LEVEL = 113, /**< ONU - Get power level. */
    BCMOLT_API_GROUP_ID_ONU_GET_POWER_CONSUMPTION = 114, /**< ONU - Get power consumption. */
    BCMOLT_API_GROUP_ID_ONU_ADJUST_TX_WAVELENGTH = 115, /**< ONU - Adjust Tx wavelength. */
    BCMOLT_API_GROUP_ID_ONU_SECURE_MUTUAL_AUTHENTICATION = 116, /**< ONU - Secure mutual authentication. */
    BCMOLT_API_GROUP_ID_ONU_TUNING_IN = 117, /**< ONU - ONU Tuning in. */
    BCMOLT_API_GROUP_ID_ONU_TUNING_OUT = 118, /**< ONU - ONU Tuning out. */
    BCMOLT_API_GROUP_ID_ONU_XGPON_ALARM = 119, /**< ONU - XGPON ONU Alarm. */
    BCMOLT_API_GROUP_ID_ONU_GPON_ALARM = 120, /**< ONU - GPON ONU Alarm. */
    BCMOLT_API_GROUP_ID_ONU_DOWI = 121, /**< ONU - Drift of Window of ONUi. */
    BCMOLT_API_GROUP_ID_ONU_SFI = 122, /**< ONU - Signal Fail of ONUi. */
    BCMOLT_API_GROUP_ID_ONU_SDI = 123, /**< ONU - Signal Degraded of ONUi. */
    BCMOLT_API_GROUP_ID_ONU_DFI = 124, /**< ONU - Receive Dying-Gasp of ONUi. */
    BCMOLT_API_GROUP_ID_ONU_PQSI = 125, /**< ONU - ploam queue status. */
    BCMOLT_API_GROUP_ID_ONU_SUFI = 126, /**< ONU - SUFi. */
    BCMOLT_API_GROUP_ID_ONU_TIWI = 127, /**< ONU - Transmission Interference Warning. */
    BCMOLT_API_GROUP_ID_ONU_LOOCI = 128, /**< ONU - LOOCi. */
    BCMOLT_API_GROUP_ID_ONU_LOAI = 129, /**< ONU - LOAi. */
    BCMOLT_API_GROUP_ID_ONU_DGI = 130, /**< ONU - Receive Dying-Gasp of ONUi. */
    BCMOLT_API_GROUP_ID_ONU_PEE = 131, /**< ONU - PEE. */
    BCMOLT_API_GROUP_ID_ONU_PST = 132, /**< ONU - PST. */
    BCMOLT_API_GROUP_ID_ONU_RANGING_COMPLETED = 133, /**< ONU - Ranging Completed. */
    BCMOLT_API_GROUP_ID_ONU_ONU_ACTIVATION_COMPLETED = 134, /**< ONU - ONU Activation Completed. */
    BCMOLT_API_GROUP_ID_ONU_ONU_DEACTIVATION_COMPLETED = 135, /**< ONU - ONU Deactivation Completed. */
    BCMOLT_API_GROUP_ID_ONU_ONU_ENABLE_COMPLETED = 136, /**< ONU - ONU Enable Completed. */
    BCMOLT_API_GROUP_ID_ONU_ONU_DISABLE_COMPLETED = 137, /**< ONU - ONU Disable Completed. */
    BCMOLT_API_GROUP_ID_ONU_RSSI_MEASUREMENT_COMPLETED = 138, /**< ONU - RSSI Measurement Completed. */
    BCMOLT_API_GROUP_ID_ONU_INVALID_DBRU_REPORT = 139, /**< ONU - Invalid DBRu Report. */
    BCMOLT_API_GROUP_ID_ONU_KEY_EXCHANGE_COMPLETED = 140, /**< ONU - Key Exchange Completed. */
    BCMOLT_API_GROUP_ID_ONU_KEY_EXCHANGE_KEY_REQUEST_TIMEOUT = 141, /**< ONU - Key Exchange Key Request Timeout. */
    BCMOLT_API_GROUP_ID_ONU_KEY_EXCHANGE_CYCLE_SKIPPED = 142, /**< ONU - Key Exchange Cycle Skipped. */
    BCMOLT_API_GROUP_ID_ONU_KEY_EXCHANGE_KEY_MISMATCH = 143, /**< ONU - Key Exchange Key Mismatch. */
    BCMOLT_API_GROUP_ID_ONU_OPTICAL_REFLECTION = 144, /**< ONU - Optical Reflection. */
    BCMOLT_API_GROUP_ID_ONU_LOKI = 145, /**< ONU - LOki. */
    BCMOLT_API_GROUP_ID_ONU_MEMI = 146, /**< ONU - MEMi. */
    BCMOLT_API_GROUP_ID_ONU_OMCI_PORT_ID_CONFIGURATION_COMPLETED = 147, /**< ONU - OMCI PORT ID Configuration Completed. */
    BCMOLT_API_GROUP_ID_ONU_BER_INTERVAL_CONFIGURATION_COMPLETED = 148, /**< ONU - BER Interval Configuration Completed. */
    BCMOLT_API_GROUP_ID_ONU_ERR = 149, /**< ONU - ERR. */
    BCMOLT_API_GROUP_ID_ONU_PASSWORD_AUTHENTICATION_COMPLETED = 150, /**< ONU - Password Authentication Completed. */
    BCMOLT_API_GROUP_ID_ONU_KEY_EXCHANGE_UNCONSECUTIVE_INDEX = 151, /**< ONU - Key Exchange Unconsecutive Index. */
    BCMOLT_API_GROUP_ID_ONU_KEY_EXCHANGE_DECRYPT_REQUIRED = 152, /**< ONU - Key Exchange Decrypt Required. */
    BCMOLT_API_GROUP_ID_ONU_ONU_ACTIVATION_STANDBY_COMPLETED = 153, /**< ONU - onu activation standby completed. */
    BCMOLT_API_GROUP_ID_ONU_POWER_MANAGEMENT_STATE_CHANGE = 154, /**< ONU - Power Management State Change. */
    BCMOLT_API_GROUP_ID_ONU_POSSIBLE_DRIFT = 155, /**< ONU - Possible Drift. */
    BCMOLT_API_GROUP_ID_ONU_REGISTRATION_ID = 156, /**< ONU - Registration ID. */
    BCMOLT_API_GROUP_ID_ONU_POWER_LEVEL_REPORT = 157, /**< ONU - Power level report. */
    BCMOLT_API_GROUP_ID_ONU_POWER_CONSUMPTION_REPORT = 158, /**< ONU - Power consumption report. */
    BCMOLT_API_GROUP_ID_ONU_SECURE_MUTUAL_AUTHENTICATION_FAILURE = 159, /**< ONU - secure mutual authentication failure. */
    BCMOLT_API_GROUP_ID_ONU_ONU_TUNING_OUT_COMPLETED = 160, /**< ONU - ONU Tuning out completed. */
    BCMOLT_API_GROUP_ID_ONU_ONU_TUNING_IN_COMPLETED = 161, /**< ONU - ONU Tuning in completed. */
    BCMOLT_API_GROUP_ID_ONU_TUNING_RESPONSE = 162, /**< ONU - Tuning response. */
    BCMOLT_API_GROUP_ID_ONU_PLOAM_PACKET = 163, /**< ONU - PLOAM Packet. */
    BCMOLT_API_GROUP_ID_ONU_CPU_PACKETS = 164, /**< ONU - XGPON CPU packets. */
    BCMOLT_API_GROUP_ID_ONU_CPU_PACKET = 165, /**< ONU - XGPON CPU packet. */
    BCMOLT_API_GROUP_ID_ONU_OMCI_PACKET = 166, /**< ONU - XGPON OMCI packet. */
    BCMOLT_API_GROUP_ID_ONU_ONU_READY_FOR_DATA_GRANT = 167, /**< ONU - ONU is ready to be granted data accesses. */
    BCMOLT_API_GROUP_ID_ONU_REI = 168, /**< ONU - REI. */
    BCMOLT_API_GROUP_ID_ONU_FORCE_DEACTIVATION = 169, /**< ONU - Force deactivation. */
    BCMOLT_API_GROUP_ID_ONU_STATE_CHANGE = 170, /**< ONU - State Change. */
    BCMOLT_API_GROUP_ID_ONU_RANGE_VALUE_CHANGED = 171, /**< ONU - Range Value Changed. */
    BCMOLT_API_GROUP_ID_ONU_AUTO_CFG = 172, /**< ONU - Indication Configuration. */
    BCMOLT_API_GROUP_ID_PBIT_TO_TC_KEY = 173, /**< pbit_to_tc - key. */
    BCMOLT_API_GROUP_ID_PBIT_TO_TC_CFG = 174, /**< pbit_to_tc - cfg. */
    BCMOLT_API_GROUP_ID_POLICER_PROFILE_KEY = 175, /**< policer (aka meter) profile - key. */
    BCMOLT_API_GROUP_ID_POLICER_PROFILE_CFG = 176, /**< policer (aka meter) profile - cfg. */
    BCMOLT_API_GROUP_ID_PON_INTERFACE_KEY = 177, /**< pon interface - key. */
    BCMOLT_API_GROUP_ID_PON_INTERFACE_CFG = 178, /**< pon interface - cfg. */
    BCMOLT_API_GROUP_ID_PON_INTERFACE_SET_PON_INTERFACE_STATE = 179, /**< pon interface - Set PON Interface State. */
    BCMOLT_API_GROUP_ID_PON_INTERFACE_SET_ONU_STATE = 180, /**< pon interface - Set ONU State. */
    BCMOLT_API_GROUP_ID_PON_INTERFACE_RESET = 181, /**< pon interface - Reset. */
    BCMOLT_API_GROUP_ID_PON_INTERFACE_DISABLE_SERIAL_NUMBER = 182, /**< pon interface - Disable Serial Number. */
    BCMOLT_API_GROUP_ID_PON_INTERFACE_SINGLE_REQUEST_STANDBY_PON_MONITORING = 183, /**< pon interface - Single request standby PON Monitoring. */
    BCMOLT_API_GROUP_ID_PON_INTERFACE_RUN_SPECIAL_BW_MAP = 184, /**< pon interface - Run Special BW Map. */
    BCMOLT_API_GROUP_ID_PON_INTERFACE_TOD_REQUEST = 185, /**< pon interface - TOD request. */
    BCMOLT_API_GROUP_ID_PON_INTERFACE_START_ONU_UPGRADE = 186, /**< pon interface - Start ONU Firmware Upgrade. */
    BCMOLT_API_GROUP_ID_PON_INTERFACE_ABORT_ONU_UPGRADE = 187, /**< pon interface - Abort ONU Firmware Upgrade. */
    BCMOLT_API_GROUP_ID_PON_INTERFACE_PROTECTION_SWITCHING_TYPE_C_SET_MULTIPLE_ONU_STATE = 188, /**< pon interface - protection switching type c set multiple onu state. */
    BCMOLT_API_GROUP_ID_PON_INTERFACE_PROTECTION_SWITCHING_APPLY_RERANGE_DELTA = 189, /**< pon interface - Protection switching apply re-range delta (IEEE). */
    BCMOLT_API_GROUP_ID_PON_INTERFACE_CPU_PACKETS = 190, /**< pon interface - XGPON CPU packets. */
    BCMOLT_API_GROUP_ID_PON_INTERFACE_BROADCAST_PLOAM_PACKET = 191, /**< pon interface - Broadcast PLOAM Packet. */
    BCMOLT_API_GROUP_ID_PON_INTERFACE_STATE_CHANGE_COMPLETED = 192, /**< pon interface - State Change Completed. */
    BCMOLT_API_GROUP_ID_PON_INTERFACE_TOD_REQUEST_COMPLETED = 193, /**< pon interface - TOD request completed. */
    BCMOLT_API_GROUP_ID_PON_INTERFACE_LOS = 194, /**< pon interface - LOS. */
    BCMOLT_API_GROUP_ID_PON_INTERFACE_SERIAL_NUMBER_ACQUISITION_CYCLE_START = 195, /**< pon interface - Serial Number Acquisition Cycle Start. */
    BCMOLT_API_GROUP_ID_PON_INTERFACE_PROTECTION_SWITCHING_TRAFFIC_RESUME = 196, /**< pon interface - Protection Switching Traffic Resume. */
    BCMOLT_API_GROUP_ID_PON_INTERFACE_PROTECTION_SWITCHING_ONUS_RANGED = 197, /**< pon interface - Protection Switching ONUs Ranged. */
    BCMOLT_API_GROUP_ID_PON_INTERFACE_PROTECTION_SWITCHING_RERANGE_FAILURE = 198, /**< pon interface - Protection Switching Re-range failure  (IEEE). */
    BCMOLT_API_GROUP_ID_PON_INTERFACE_PROTECTION_SWITCHING_SWITCHOVER_COMPLETED = 199, /**< pon interface - Protection Switching Switchover Completed. */
    BCMOLT_API_GROUP_ID_PON_INTERFACE_STANDBY_PON_MONITORING_CYCLE_COMPLETED = 200, /**< pon interface - Standby PON Monitoring Cycle Completed. */
    BCMOLT_API_GROUP_ID_PON_INTERFACE_ONU_DISCOVERED = 201, /**< pon interface - ONU Discovered. */
    BCMOLT_API_GROUP_ID_PON_INTERFACE_CPU_PACKETS_FAILURE = 202, /**< pon interface - CPU Packets Failure. */
    BCMOLT_API_GROUP_ID_PON_INTERFACE_DEACTIVATE_ALL_ONUS_COMPLETED = 203, /**< pon interface - deactivate all onus completed. */
    BCMOLT_API_GROUP_ID_PON_INTERFACE_DISABLE_ALL_ONUS_COMPLETED = 204, /**< pon interface - disable all onus completed. */
    BCMOLT_API_GROUP_ID_PON_INTERFACE_ACTIVATE_ALL_ONUS_COMPLETED = 205, /**< pon interface - activate all onus completed. */
    BCMOLT_API_GROUP_ID_PON_INTERFACE_ENABLE_ALL_ONUS_COMPLETED = 206, /**< pon interface - enable all onus completed. */
    BCMOLT_API_GROUP_ID_PON_INTERFACE_ONU_UPGRADE_COMPLETE = 207, /**< pon interface - ONU Upgrade Complete. */
    BCMOLT_API_GROUP_ID_PON_INTERFACE_IEEE_ROGUE_DETECTION_COMPLETED = 208, /**< pon interface - IEEE Rogue Detection Completed. */
    BCMOLT_API_GROUP_ID_PON_INTERFACE_MPCP_TIMESTAMP_CHANGED = 209, /**< pon interface - MPCP Timestamp Changed. */
    BCMOLT_API_GROUP_ID_PON_INTERFACE_SWITCH_PON_TYPE = 210, /**< pon interface - Switch PON type. */
    BCMOLT_API_GROUP_ID_PON_INTERFACE_SWITCH_PON_TYPE_COMPLETED = 211, /**< pon interface - Switch PON type completed. */
    BCMOLT_API_GROUP_ID_PON_INTERFACE_GET_BW_ELIGIBILITY_STATS = 212, /**< pon interface - Get BW eligibility class level statistics. */
    BCMOLT_API_GROUP_ID_PON_INTERFACE_GET_BW_ELIGIBILITY_STATS_COMPLETED = 213, /**< pon interface - Get BW eligibility class level statistics completed. */
    BCMOLT_API_GROUP_ID_PON_INTERFACE_AUTO_CFG = 214, /**< pon interface - Indication Configuration. */
    BCMOLT_API_GROUP_ID_PROTECTION_INTERFACE_KEY = 215, /**< Protection Interface - key. */
    BCMOLT_API_GROUP_ID_PROTECTION_INTERFACE_CFG = 216, /**< Protection Interface - cfg. */
    BCMOLT_API_GROUP_ID_PROTECTION_INTERFACE_PROTECTION_SWITCH = 217, /**< Protection Interface - Protection Switch. */
    BCMOLT_API_GROUP_ID_PROTECTION_INTERFACE_PROTECTION_SWITCH_COMPLETED = 218, /**< Protection Interface - Protection Switch Completed. */
    BCMOLT_API_GROUP_ID_PROTECTION_INTERFACE_AUTO_CFG = 219, /**< Protection Interface - Indication Configuration. */
    BCMOLT_API_GROUP_ID_SOFTWARE_ERROR_KEY = 220, /**< Software Error - key. */
    BCMOLT_API_GROUP_ID_SOFTWARE_ERROR_CFG = 221, /**< Software Error - cfg. */
    BCMOLT_API_GROUP_ID_SWITCH_INNI_KEY = 222, /**< switch inni - key. */
    BCMOLT_API_GROUP_ID_SWITCH_INNI_CFG = 223, /**< switch inni - cfg. */
    BCMOLT_API_GROUP_ID_TC_TO_QUEUE_KEY = 224, /**< tc_to_queue - key. */
    BCMOLT_API_GROUP_ID_TC_TO_QUEUE_CFG = 225, /**< tc_to_queue - cfg. */
    BCMOLT_API_GROUP_ID_TM_QMP_KEY = 226, /**< tm_qmp - key. */
    BCMOLT_API_GROUP_ID_TM_QMP_CFG = 227, /**< tm_qmp - cfg. */
    BCMOLT_API_GROUP_ID_TM_QUEUE_KEY = 228, /**< tm_queue - key. */
    BCMOLT_API_GROUP_ID_TM_QUEUE_CFG = 229, /**< tm_queue - cfg. */
    BCMOLT_API_GROUP_ID_TM_SCHED_KEY = 230, /**< tm_sched - key. */
    BCMOLT_API_GROUP_ID_TM_SCHED_CFG = 231, /**< tm_sched - cfg. */
...
typedef enum
{
    ...
    BCMOLT_ERPS_INTERFACE_AUTO_SUBGROUP_ERPS_PORT_UPDATE = 1, /**< erps port update. */
...
#define bcmolt_erps_interface_auto_subgroup_erps_port_update BCMOLT_ERPS_INTERFACE_AUTO_SUBGROUP_ERPS_PORT_UPDATE
...
typedef enum
{
    ...
    BCMOLT_INTERNAL_NNI_AUTO_SUBGROUP_PACKET_CAPTURED = 1, /**< Packet Captured. */
    BCMOLT_INTERNAL_NNI_AUTO_SUBGROUP_STATUS_CHANGED = 2, /**< Status changed. */
...
#define bcmolt_internal_nni_auto_subgroup_full_mask 0x7
...
typedef enum
{
    ...
    BCMOLT_ONU_AUTO_SUBGROUP_RANGE_VALUE_CHANGED = 38, /**< Range Value Changed. */
    BCMOLT_ONU_AUTO_SUBGROUP_RANGING_COMPLETED = 39, /**< Ranging Completed. */
    BCMOLT_ONU_AUTO_SUBGROUP_REGISTRATION_ID = 40, /**< Registration ID. */
    BCMOLT_ONU_AUTO_SUBGROUP_REI = 41, /**< REI. */
    BCMOLT_ONU_AUTO_SUBGROUP_RSSI_MEASUREMENT_COMPLETED = 42, /**< RSSI Measurement Completed. */
    BCMOLT_ONU_AUTO_SUBGROUP_SDI = 43, /**< Signal Degraded of ONUi. */
    BCMOLT_ONU_AUTO_SUBGROUP_SECURE_MUTUAL_AUTHENTICATION_FAILURE = 44, /**< secure mutual authentication failure. */
    BCMOLT_ONU_AUTO_SUBGROUP_SFI = 45, /**< Signal Fail of ONUi. */
    BCMOLT_ONU_AUTO_SUBGROUP_STATE_CHANGE = 46, /**< State Change. */
    BCMOLT_ONU_AUTO_SUBGROUP_SUFI = 47, /**< SUFi. */
    BCMOLT_ONU_AUTO_SUBGROUP_TIWI = 48, /**< Transmission Interference Warning. */
    BCMOLT_ONU_AUTO_SUBGROUP_TUNING_RESPONSE = 49, /**< Tuning response. */
    BCMOLT_ONU_AUTO_SUBGROUP_XGPON_ALARM = 50, /**< XGPON ONU Alarm. */
...
#define bcmolt_onu_auto_subgroup_full_mask 0x7FFFFFFFFFFFF
...
typedef enum
{
    ...
    BCMOLT_PON_INTERFACE_AUTO_SUBGROUP_GET_BW_ELIGIBILITY_STATS_COMPLETED = 6, /**< Get BW eligibility class level statistics completed. */
    BCMOLT_PON_INTERFACE_AUTO_SUBGROUP_IEEE_ROGUE_DETECTION_COMPLETED = 7, /**< IEEE Rogue Detection Completed. */
    BCMOLT_PON_INTERFACE_AUTO_SUBGROUP_LOS = 8, /**< LOS. */
    BCMOLT_PON_INTERFACE_AUTO_SUBGROUP_MPCP_TIMESTAMP_CHANGED = 9, /**< MPCP Timestamp Changed. */
    BCMOLT_PON_INTERFACE_AUTO_SUBGROUP_ONU_DISCOVERED = 10, /**< ONU Discovered. */
    BCMOLT_PON_INTERFACE_AUTO_SUBGROUP_ONU_UPGRADE_COMPLETE = 11, /**< ONU Upgrade Complete. */
    BCMOLT_PON_INTERFACE_AUTO_SUBGROUP_PROTECTION_SWITCHING_ONUS_RANGED = 12, /**< Protection Switching ONUs Ranged. */
    BCMOLT_PON_INTERFACE_AUTO_SUBGROUP_PROTECTION_SWITCHING_RERANGE_FAILURE = 13, /**< Protection Switching Re-range failure  (IEEE). */
    BCMOLT_PON_INTERFACE_AUTO_SUBGROUP_PROTECTION_SWITCHING_SWITCHOVER_COMPLETED = 14, /**< Protection Switching Switchover Completed. */
    BCMOLT_PON_INTERFACE_AUTO_SUBGROUP_PROTECTION_SWITCHING_TRAFFIC_RESUME = 15, /**< Protection Switching Traffic Resume. */
    BCMOLT_PON_INTERFACE_AUTO_SUBGROUP_SERIAL_NUMBER_ACQUISITION_CYCLE_START = 16, /**< Serial Number Acquisition Cycle Start. */
    BCMOLT_PON_INTERFACE_AUTO_SUBGROUP_STANDBY_PON_MONITORING_CYCLE_COMPLETED = 17, /**< Standby PON Monitoring Cycle Completed. */
    BCMOLT_PON_INTERFACE_AUTO_SUBGROUP_STATE_CHANGE_COMPLETED = 18, /**< State Change Completed. */
    BCMOLT_PON_INTERFACE_AUTO_SUBGROUP_SWITCH_PON_TYPE_COMPLETED = 19, /**< Switch PON type completed. */
    BCMOLT_PON_INTERFACE_AUTO_SUBGROUP_TOD_REQUEST_COMPLETED = 20, /**< TOD request completed. */
...
#define bcmolt_pon_interface_auto_subgroup_get_bw_eligibility_stats_completed BCMOLT_PON_INTERFACE_AUTO_SUBGROUP_GET_BW_ELIGIBILITY_STATS_COMPLETED
...
#define bcmolt_pon_interface_auto_subgroup_full_mask 0x1FFFFF
...
typedef enum
{
    ...
    BCMOLT_PON_INTERFACE_OPER_SUBGROUP_GET_BW_ELIGIBILITY_STATS = 5, /**< Get BW eligibility class level statistics. */
...
#define bcmolt_pon_interface_oper_subgroup_get_bw_eligibility_stats BCMOLT_PON_INTERFACE_OPER_SUBGROUP_GET_BW_ELIGIBILITY_STATS
...
#define bcmolt_device_cfg_data_id_full_mask 0xF81F3EFF
...
#define bcmolt_device_connect_data_id_full_mask 0xEF
...
typedef enum
{
    ...
    BCMOLT_ERPS_INTERFACE_PORT_UPDATE_DATA_ID_COMMAND = 0, /**< Update an ERPS ring port. */
...
#define bcmolt_erps_interface_port_update_data_id_full_mask 0x5

} bcmolt_erps_interface_port_update_data_id;

/** Identifiers for all fields in a 'erps_interface_erps_port_update_data'. */
typedef enum
{
    BCMOLT_ERPS_INTERFACE_ERPS_PORT_UPDATE_DATA_ID__BEGIN = 0,
    BCMOLT_ERPS_INTERFACE_ERPS_PORT_UPDATE_DATA_ID_COMMAND = 0, /**< Command just executed. */
    BCMOLT_ERPS_INTERFACE_ERPS_PORT_UPDATE_DATA_ID_INTF_REF = 1, /**< Modified Port. */
    BCMOLT_ERPS_INTERFACE_ERPS_PORT_UPDATE_DATA_ID_RESULT = 2, /**< Result of command pass/fail. */
    BCMOLT_ERPS_INTERFACE_ERPS_PORT_UPDATE_DATA_ID__NUM_OF, /**< Constant to use for sizing arrays - note that enum may have holes. */

    /* Lower-case versions for macro support. */
#define bcmolt_erps_interface_erps_port_update_data_id__begin BCMOLT_ERPS_INTERFACE_ERPS_PORT_UPDATE_DATA_ID__BEGIN
#define bcmolt_erps_interface_erps_port_update_data_id_command BCMOLT_ERPS_INTERFACE_ERPS_PORT_UPDATE_DATA_ID_COMMAND
#define bcmolt_erps_interface_erps_port_update_data_id_intf_ref BCMOLT_ERPS_INTERFACE_ERPS_PORT_UPDATE_DATA_ID_INTF_REF
#define bcmolt_erps_interface_erps_port_update_data_id_result BCMOLT_ERPS_INTERFACE_ERPS_PORT_UPDATE_DATA_ID_RESULT
#define bcmolt_erps_interface_erps_port_update_data_id__num_of BCMOLT_ERPS_INTERFACE_ERPS_PORT_UPDATE_DATA_ID__NUM_OF
#define bcmolt_erps_interface_erps_port_update_data_id_all_properties 0xFF
#define bcmolt_erps_interface_erps_port_update_data_id_full_mask 0x7

} bcmolt_erps_interface_erps_port_update_data_id;

/** Identifiers for all fields in a 'erps_interface_auto_cfg_data'. */
typedef enum
{
    BCMOLT_ERPS_INTERFACE_AUTO_CFG_DATA_ID__BEGIN = 0,
    BCMOLT_ERPS_INTERFACE_AUTO_CFG_DATA_ID_ERPS_PORT_UPDATE = 0, /**< erps port update. */
...
#define bcmolt_erps_interface_auto_cfg_data_id_erps_port_update BCMOLT_ERPS_INTERFACE_AUTO_CFG_DATA_ID_ERPS_PORT_UPDATE
...
#define bcmolt_flow_cfg_data_id_full_mask 0x3FFF
...
#define bcmolt_internal_nni_cfg_data_id_full_mask 0xFBE
...
typedef enum
{
    ...
    BCMOLT_INTERNAL_NNI_AUTO_CFG_DATA_ID_PACKET_CAPTURED = 0, /**< Packet Captured. */
    BCMOLT_INTERNAL_NNI_AUTO_CFG_DATA_ID_STATUS_CHANGED = 1, /**< Status changed. */
...
#define bcmolt_internal_nni_auto_cfg_data_id_full_mask 0x3
...
#define bcmolt_nni_interface_cfg_data_id_full_mask 0xFFB
...
typedef enum
{
    ...
    BCMOLT_ONU_AUTO_CFG_DATA_ID_RANGE_VALUE_CHANGED = 37, /**< Range Value Changed. */
    BCMOLT_ONU_AUTO_CFG_DATA_ID_RANGING_COMPLETED = 38, /**< Ranging Completed. */
    BCMOLT_ONU_AUTO_CFG_DATA_ID_REGISTRATION_ID = 39, /**< Registration ID. */
    BCMOLT_ONU_AUTO_CFG_DATA_ID_REI = 40, /**< REI. */
    BCMOLT_ONU_AUTO_CFG_DATA_ID_RSSI_MEASUREMENT_COMPLETED = 41, /**< RSSI Measurement Completed. */
    BCMOLT_ONU_AUTO_CFG_DATA_ID_SDI = 42, /**< Signal Degraded of ONUi. */
    BCMOLT_ONU_AUTO_CFG_DATA_ID_SECURE_MUTUAL_AUTHENTICATION_FAILURE = 43, /**< secure mutual authentication failure. */
    BCMOLT_ONU_AUTO_CFG_DATA_ID_SFI = 44, /**< Signal Fail of ONUi. */
    BCMOLT_ONU_AUTO_CFG_DATA_ID_STATE_CHANGE = 45, /**< State Change. */
    BCMOLT_ONU_AUTO_CFG_DATA_ID_SUFI = 46, /**< SUFi. */
    BCMOLT_ONU_AUTO_CFG_DATA_ID_TIWI = 47, /**< Transmission Interference Warning. */
    BCMOLT_ONU_AUTO_CFG_DATA_ID_TUNING_RESPONSE = 48, /**< Tuning response. */
    BCMOLT_ONU_AUTO_CFG_DATA_ID_XGPON_ALARM = 49, /**< XGPON ONU Alarm. */
...
#define bcmolt_onu_auto_cfg_data_id_full_mask 0x3FFFFFFFFFFFF
...
/** Identifiers for all fields in a 'pon_interface_get_bw_eligibility_stats_data'. */
typedef enum
{
    BCMOLT_PON_INTERFACE_GET_BW_ELIGIBILITY_STATS_DATA_ID__BEGIN = 0,
    BCMOLT_PON_INTERFACE_GET_BW_ELIGIBILITY_STATS_DATA_ID_BW_ELIGIBILITY = 0, /**< BW eligibility class. */
    BCMOLT_PON_INTERFACE_GET_BW_ELIGIBILITY_STATS_DATA_ID_PRIORITY = 1, /**< Priority. */
    BCMOLT_PON_INTERFACE_GET_BW_ELIGIBILITY_STATS_DATA_ID_NUM_OF_CYCLES = 2, /**< Number of cycles. */
    BCMOLT_PON_INTERFACE_GET_BW_ELIGIBILITY_STATS_DATA_ID__NUM_OF, /**< Constant to use for sizing arrays - note that enum may have holes. */

    /* Lower-case versions for macro support. */
#define bcmolt_pon_interface_get_bw_eligibility_stats_data_id__begin BCMOLT_PON_INTERFACE_GET_BW_ELIGIBILITY_STATS_DATA_ID__BEGIN
#define bcmolt_pon_interface_get_bw_eligibility_stats_data_id_bw_eligibility BCMOLT_PON_INTERFACE_GET_BW_ELIGIBILITY_STATS_DATA_ID_BW_ELIGIBILITY
#define bcmolt_pon_interface_get_bw_eligibility_stats_data_id_priority BCMOLT_PON_INTERFACE_GET_BW_ELIGIBILITY_STATS_DATA_ID_PRIORITY
#define bcmolt_pon_interface_get_bw_eligibility_stats_data_id_num_of_cycles BCMOLT_PON_INTERFACE_GET_BW_ELIGIBILITY_STATS_DATA_ID_NUM_OF_CYCLES
#define bcmolt_pon_interface_get_bw_eligibility_stats_data_id__num_of BCMOLT_PON_INTERFACE_GET_BW_ELIGIBILITY_STATS_DATA_ID__NUM_OF
#define bcmolt_pon_interface_get_bw_eligibility_stats_data_id_all_properties 0xFF
#define bcmolt_pon_interface_get_bw_eligibility_stats_data_id_full_mask 0x7

} bcmolt_pon_interface_get_bw_eligibility_stats_data_id;

/** Identifiers for all fields in a 'pon_interface_get_bw_eligibility_stats_completed_data'. */
typedef enum
{
    BCMOLT_PON_INTERFACE_GET_BW_ELIGIBILITY_STATS_COMPLETED_DATA_ID__BEGIN = 0,
    BCMOLT_PON_INTERFACE_GET_BW_ELIGIBILITY_STATS_COMPLETED_DATA_ID_STATUS = 0, /**< status. */
    BCMOLT_PON_INTERFACE_GET_BW_ELIGIBILITY_STATS_COMPLETED_DATA_ID_AVERAGE_NSR_USED = 1, /**< Average NSR used words. */
    BCMOLT_PON_INTERFACE_GET_BW_ELIGIBILITY_STATS_COMPLETED_DATA_ID_AVERAGE_NSR_ALLOCATED = 2, /**< Average NSR allocated words. */
    BCMOLT_PON_INTERFACE_GET_BW_ELIGIBILITY_STATS_COMPLETED_DATA_ID_AVERAGE_SR_REPORT = 3, /**< Average SR report. */
    BCMOLT_PON_INTERFACE_GET_BW_ELIGIBILITY_STATS_COMPLETED_DATA_ID_BW_ELIGIBILITY = 4, /**< BW eligibility class. */
    BCMOLT_PON_INTERFACE_GET_BW_ELIGIBILITY_STATS_COMPLETED_DATA_ID_PRIORITY = 5, /**< Priority. */
    BCMOLT_PON_INTERFACE_GET_BW_ELIGIBILITY_STATS_COMPLETED_DATA_ID__NUM_OF, /**< Constant to use for sizing arrays - note that enum may have holes. */

    /* Lower-case versions for macro support. */
#define bcmolt_pon_interface_get_bw_eligibility_stats_completed_data_id__begin BCMOLT_PON_INTERFACE_GET_BW_ELIGIBILITY_STATS_COMPLETED_DATA_ID__BEGIN
#define bcmolt_pon_interface_get_bw_eligibility_stats_completed_data_id_status BCMOLT_PON_INTERFACE_GET_BW_ELIGIBILITY_STATS_COMPLETED_DATA_ID_STATUS
#define bcmolt_pon_interface_get_bw_eligibility_stats_completed_data_id_average_nsr_used BCMOLT_PON_INTERFACE_GET_BW_ELIGIBILITY_STATS_COMPLETED_DATA_ID_AVERAGE_NSR_USED
#define bcmolt_pon_interface_get_bw_eligibility_stats_completed_data_id_average_nsr_allocated BCMOLT_PON_INTERFACE_GET_BW_ELIGIBILITY_STATS_COMPLETED_DATA_ID_AVERAGE_NSR_ALLOCATED
#define bcmolt_pon_interface_get_bw_eligibility_stats_completed_data_id_average_sr_report BCMOLT_PON_INTERFACE_GET_BW_ELIGIBILITY_STATS_COMPLETED_DATA_ID_AVERAGE_SR_REPORT
#define bcmolt_pon_interface_get_bw_eligibility_stats_completed_data_id_bw_eligibility BCMOLT_PON_INTERFACE_GET_BW_ELIGIBILITY_STATS_COMPLETED_DATA_ID_BW_ELIGIBILITY
#define bcmolt_pon_interface_get_bw_eligibility_stats_completed_data_id_priority BCMOLT_PON_INTERFACE_GET_BW_ELIGIBILITY_STATS_COMPLETED_DATA_ID_PRIORITY
#define bcmolt_pon_interface_get_bw_eligibility_stats_completed_data_id__num_of BCMOLT_PON_INTERFACE_GET_BW_ELIGIBILITY_STATS_COMPLETED_DATA_ID__NUM_OF
#define bcmolt_pon_interface_get_bw_eligibility_stats_completed_data_id_all_properties 0xFF
#define bcmolt_pon_interface_get_bw_eligibility_stats_completed_data_id_full_mask 0x3F

} bcmolt_pon_interface_get_bw_eligibility_stats_completed_data_id;
...
typedef enum
{
    ...
    BCMOLT_PON_INTERFACE_AUTO_CFG_DATA_ID_GET_BW_ELIGIBILITY_STATS_COMPLETED = 5, /**< Get BW eligibility class level statistics completed. */
    BCMOLT_PON_INTERFACE_AUTO_CFG_DATA_ID_IEEE_ROGUE_DETECTION_COMPLETED = 6, /**< IEEE Rogue Detection Completed. */
    BCMOLT_PON_INTERFACE_AUTO_CFG_DATA_ID_LOS = 7, /**< LOS. */
    BCMOLT_PON_INTERFACE_AUTO_CFG_DATA_ID_MPCP_TIMESTAMP_CHANGED = 8, /**< MPCP Timestamp Changed. */
    BCMOLT_PON_INTERFACE_AUTO_CFG_DATA_ID_ONU_DISCOVERED = 9, /**< ONU Discovered. */
    BCMOLT_PON_INTERFACE_AUTO_CFG_DATA_ID_ONU_UPGRADE_COMPLETE = 10, /**< ONU Upgrade Complete. */
    BCMOLT_PON_INTERFACE_AUTO_CFG_DATA_ID_PROTECTION_SWITCHING_ONUS_RANGED = 11, /**< Protection Switching ONUs Ranged. */
    BCMOLT_PON_INTERFACE_AUTO_CFG_DATA_ID_PROTECTION_SWITCHING_RERANGE_FAILURE = 12, /**< Protection Switching Re-range failure  (IEEE). */
    BCMOLT_PON_INTERFACE_AUTO_CFG_DATA_ID_PROTECTION_SWITCHING_SWITCHOVER_COMPLETED = 13, /**< Protection Switching Switchover Completed. */
    BCMOLT_PON_INTERFACE_AUTO_CFG_DATA_ID_PROTECTION_SWITCHING_TRAFFIC_RESUME = 14, /**< Protection Switching Traffic Resume. */
    BCMOLT_PON_INTERFACE_AUTO_CFG_DATA_ID_SERIAL_NUMBER_ACQUISITION_CYCLE_START = 15, /**< Serial Number Acquisition Cycle Start. */
    BCMOLT_PON_INTERFACE_AUTO_CFG_DATA_ID_STANDBY_PON_MONITORING_CYCLE_COMPLETED = 16, /**< Standby PON Monitoring Cycle Completed. */
    BCMOLT_PON_INTERFACE_AUTO_CFG_DATA_ID_STATE_CHANGE_COMPLETED = 17, /**< State Change Completed. */
    BCMOLT_PON_INTERFACE_AUTO_CFG_DATA_ID_SWITCH_PON_TYPE_COMPLETED = 18, /**< Switch PON type completed. */
    BCMOLT_PON_INTERFACE_AUTO_CFG_DATA_ID_TOD_REQUEST_COMPLETED = 19, /**< TOD request completed. */
...
#define bcmolt_pon_interface_auto_cfg_data_id_get_bw_eligibility_stats_completed BCMOLT_PON_INTERFACE_AUTO_CFG_DATA_ID_GET_BW_ELIGIBILITY_STATS_COMPLETED
...
#define bcmolt_pon_interface_auto_cfg_data_id_full_mask 0xFFFFF
