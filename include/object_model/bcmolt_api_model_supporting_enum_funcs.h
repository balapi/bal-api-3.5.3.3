...
/** Packs an enumeration to bytes for transmission on the wire.
  ...
  * \return Whether or not the pack was successful.
  */
bcmos_bool bcmolt_erps_interface_erps_port_update_data_id_pack(
    bcmolt_erps_interface_erps_port_update_data_id obj,
    bcmolt_buf *buf);
...
/** Unpacks an enumeration from bytes as received on the wire.
  ...
  * \return Whether or not the unpack was successful.
  */
bcmos_bool bcmolt_erps_interface_erps_port_update_data_id_unpack(
    bcmolt_erps_interface_erps_port_update_data_id *obj,
    bcmolt_buf *buf);
...
/** Packs an enumeration to bytes for transmission on the wire.
  ...
  * \return Whether or not the pack was successful.
  */
bcmos_bool bcmolt_pon_interface_get_bw_eligibility_stats_data_id_pack(
    bcmolt_pon_interface_get_bw_eligibility_stats_data_id obj,
    bcmolt_buf *buf);
...
/** Unpacks an enumeration from bytes as received on the wire.
  ...
  * \return Whether or not the unpack was successful.
  */
bcmos_bool bcmolt_pon_interface_get_bw_eligibility_stats_data_id_unpack(
    bcmolt_pon_interface_get_bw_eligibility_stats_data_id *obj,
    bcmolt_buf *buf);
...
/** Packs an enumeration to bytes for transmission on the wire.
  ...
  * \return Whether or not the pack was successful.
  */
bcmos_bool bcmolt_pon_interface_get_bw_eligibility_stats_completed_data_id_pack(
    bcmolt_pon_interface_get_bw_eligibility_stats_completed_data_id obj,
    bcmolt_buf *buf);
...
/** Unpacks an enumeration from bytes as received on the wire.
  ...
  * \return Whether or not the unpack was successful.
  */
bcmos_bool bcmolt_pon_interface_get_bw_eligibility_stats_completed_data_id_unpack(
    bcmolt_pon_interface_get_bw_eligibility_stats_completed_data_id *obj,
    bcmolt_buf *buf);
